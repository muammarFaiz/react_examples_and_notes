...
import Tryform from './childs/tryform/tryform'
import Form_respond, { form_action } from './form_respond'
...
const router = createHashRouter([
  ...
  {path: '/', element: <App />, errorElement: <ErrEl />, children: [
    ...
    {path: 'madeup/:madeup', element: <Madeup_param />, loader: mp_loader},
    {path: 'tryform', element: <Tryform />},
  ]},
  {path: 'nested1', element: <Nested1 />, children: [
    {path: 'nested2', element: <Nested2 />},
  ]},
  {path: 'tryform_action', element: <Form_respond />, action: form_action},
